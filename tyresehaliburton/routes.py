...
from utils import fetch_current_season_assist_leaders, create_assist_leaders_bar_graph, fetch_top_10_players_avg_assists_2023_24, create_avg_assists_bar_plot, assist_turnover_boxplot, shots_made_plot
...
def configure_routes(app):
    ...
    def haliburton():
        try:
            ...
            return render_template('haliburton.html',  graph_html = graph_html, graph_html2 = graph_html2, graph_html3=graph_html3, graph_html4=graph_html4)
